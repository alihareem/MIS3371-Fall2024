...
//building the review button
               ...
               if (formcontent.elements[i].value != "") {
                      ...
                      switch (datatype) {
                       ...
                       case "radio":
                            if (formcontent.elements[i].checked) { 
                                  formoutput = formoutput + "<tr> <td align='right'" + formcontent.elements[i].name + "</td">;
                                  formcontent = "<td class = 'outputdata'>" + formcontent.elements[i].value + "</td></tr>";
                            }
                            break;
                       case "button":
                       case "submit":
                       case "reset":
                            break;
                       default: 
                                   formoutput = formoutput + "<tr><td align='right'>" + formcontent.elements[i].name + "v/td>";
 ...
 if (formoutput.length > 0) {
       ...
       document.getElemenyById("showInput").innerHTML = formoutput;
 }
